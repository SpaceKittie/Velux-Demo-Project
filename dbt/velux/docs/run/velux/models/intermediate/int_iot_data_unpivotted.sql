        ...
        create or replace transient table VELUX_DEV.STAGING.int_iot_data_unpivotted
  ...
  (
    ...
    sensor_value float
         ...
         as
        (
    select event_timestamp, country, city, device_id, room, sensor_type, sensor_value
    from (
